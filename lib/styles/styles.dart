...
Color backgroundColor = const Color(0xff020402);
...
Color topBar = const Color(0xff020402);
Color page = const Color(0xff020402);
Color buttonColor = const Color(0xff9EF01A);
Color theme = const Color(0xff9EF01A);
...
Color loaderColor = const Color(0xff9EF01A);
